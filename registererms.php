...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($link, "select EmpEmail from employeedetail where EmpEmail='$Email'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email already associated with another account";
    }
    else{
    $query=mysqli_query($link, "insert into employeedetail(EmpFname, EmpLName, EmpCode, EmpEmail,  EmpPassword) value('$FName', '$LName', '$empcode', '$Email', '$Password' )");
    if ($query) {
...
<head>
  ...
  <title>ABMTC Alumni Record Managment System</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 1%">ABMTC Alumni Record Managment System</h3>
              ...
              <form class="user" name="register" method="post" onsubmit="return checkpass();">
                <div class="form-group row">
                 ...
                 <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="empcode" name="empcode" placeholder="Enter your ABMTC Alumni Code" pattern="[0-9]+" required="true">
                </div>
                <div class="form-group">
