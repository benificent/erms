...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $msg="ABMTC Alumni profile has been updated.";
  }
  else
    {
...
<head>
  ...
  <title>Edit ABMTC Alumni Profile</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit ABMTC Alumni Profile</h1>
...
<form class="user" method="post" action="">
  <?php
$aid=$_GET['editid'];
$ret=mysqli_query($link,"select * from employeedetail where ID='$aid'");
$cnt=1;
               ...
               <div class="row">
                <div class="col-4 mb-3">First Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="FirstName" name="FirstName" aria-describedby="emailHelp" value="<?php  echo $row['EmpFname'];?>"></div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">ABMTC Alumni Code </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">ABMTC Alumni Dept</div>
                     <div class="col-8 mb-3">
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">ABMTC Alumni Desigantion</div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">ABMTC Alumni Contact No.</div>
                    <div class="col-8 mb-3">
                   ...
                   <div class="col-8 mb-3">
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">ABMTC Alumni Joing Date(yyyy-mm-dd)</div>
                    <div class="col-8  mb-3">
