...
<script type="text/javascript">
        function validate_form() {
            if (document.emp.emp_name.value == "") {
                alert("Please fill in the 'Your ABMTC Alumni Name' box.");
                return false;
            }
            if (document.emp.num.value == "") {
                alert("Enter ABMTC Alumni Number");
                return false;
            }
...
<form name="emp" action="" onsubmit="return validate_form();" method="post">
        <table align="center" width=40% width="100%" cellspacing="2" cellpadding="2" border="5">
            <tr>
                <td colspan="2" align="center"><b>ABMTC Alumni Registration Form.</b></td>
 
            </tr>
            <tr>
                <td align="left" valign="top" width="41%">ABMTC Alumni Name<span style="color:red">*</span></td>
 
                <td width="57%"><input type="text" value="" name="emp_name" size="24"></td>
            </tr>
            <tr>
                <td align="left" valign="top" width="41%">ABMTC Alumni Number<span style="color:red">*</span></td>
                <td width="57%">
