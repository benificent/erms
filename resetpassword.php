...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($link,"update employeedetail set EmpPassword='$password'  where  EmpEmail='$email' && EmpCode='$empid' ");
   if($query)
   {
...
<head>
  ...
  <meta name="viewport" content="ABMTC Alumni Record management System in php and mysql">
  <meta name="description" content="ABMTC Alumni Record management System in php and mysql">
  <meta name="author" content="Sarita Pandey">

  <title>ERMS ABMTC Alumni Reset</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">ABMTC Alumni Record Managment System</h3>
